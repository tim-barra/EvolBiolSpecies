...
##Figure 2.3, panel C - assortative mating + geographic isolation + div selection, eco and repro traits are uncorrelated
...
for (gen in (1:ngen)) {
	...
	tmp<-rdist(rowSums(repro)+rnorm(nindiv,0,sqrt(pheno.var.repro)))	
